...
# source: bgx_settings/protobuf/client_list_control.proto
...
ClientPagingControls = _reflection.GeneratedProtocolMessageType('ClientPagingControls', (_message.Message,), dict(
  ...
  __module__ = 'bgx_settings.protobuf.client_list_control_pb2'
