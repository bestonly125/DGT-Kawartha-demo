...
# source: bgx_settings/protobuf/network.proto
...
DisconnectMessage = _reflection.GeneratedProtocolMessageType('DisconnectMessage', (_message.Message,), dict(
  ...
  __module__ = 'bgx_settings.protobuf.network_pb2'
