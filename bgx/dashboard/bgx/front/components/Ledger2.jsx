...
class Ledger2 extends React.Component {
  constructor(props){
    super(props);
            ...
            <div >
              <div className='row'>
                <div className='col-10'>
                  <Graph2 data={data} id='ledger2_graph' title='Ledger 2.0'
                    btns={[{name: 'Update', handler: this.update}]}
                    size={{width: 878, height: 5000}}
...
export default connect (mapStateToProps, null)(Ledger2);
